...
create memory table T_USER_ARTICLE ( USA_ID_C varchar(36) not null, USA_IDUSER_C varchar(36) not null, USA_IDARTICLE_C varchar(36) not null, USA_CREATEDATE_D datetime not null, USA_READDATE_D datetime, USA_STARREDDATE_D datetime, USA_DELETEDATE_D datetime, primary key (USA_ID_C),USA_FEEDNAMES_C varchar(100) );
create memory table T_BUG_REPORT ( BUG_ID_C varchar(36) not null, BUG_IDUSER_C varchar(50) not null, BUG_DESCRIPTION_C varchar(4000), BUG_CREATEDATE_D datetime not null, BUG_STATUS_D varchar(36), BUG_DELETE_STATUS varchar(36), primary key (BUG_ID_C) );
...
alter table T_BUG_REPORT add constraint FK_BUG_IDUSER_C foreign key (BUG_IDUSER_C) references T_USER (USE_ID_C) on delete restrict on update restrict;
...
insert into T_USER(USE_ID_C, USE_IDLOCALE_C, USE_IDROLE_C, USE_USERNAME_C, USE_PASSWORD_C, USE_EMAIL_C, USE_THEME_C, USE_DISPLAYTITLEWEB_B, USE_DISPLAYTITLEMOBILE_B, USE_DISPLAYUNREADWEB_B, USE_DISPLAYUNREADMOBILE_B, USE_FIRSTCONNECTION_B, USE_CREATEDATE_D) values('simpson', 'en', 'user', 'simpson', '$2a$05$6Ny3TjrW3aVAL1or2SlcR.fhuDgPKp5jp.P9fBXwVNePgeLqb4i3C', 'simpson@localhost', 'default.less', false, true, true, true, true, NOW());
insert into T_USER(USE_ID_C, USE_IDLOCALE_C, USE_IDROLE_C, USE_USERNAME_C, USE_PASSWORD_C, USE_EMAIL_C, USE_THEME_C, USE_DISPLAYTITLEWEB_B, USE_DISPLAYTITLEMOBILE_B, USE_DISPLAYUNREADWEB_B, USE_DISPLAYUNREADMOBILE_B, USE_FIRSTCONNECTION_B, USE_CREATEDATE_D) values('user', 'en', 'user', 'user', '$2a$05$6Ny3TjrW3aVAL1or2SlcR.fhuDgPKp5jp.P9fBXwVNePgeLqb4i3C', 'user@localhost', 'default.less', false, true, true, true, true, NOW());
