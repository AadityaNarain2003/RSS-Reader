...
public class RssReader extends DefaultHandler {
    ...
    public void readRssFeed(InputStream is) throws Exception {
        ...
        if (feedType == FeedType.ATOM) {
            AtomUrlGuesser strategy = new AtomUrlGuesser();
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if ("title".equalsIgnoreCase(localName) && currentElement == Element.RSS_TITLE) {
            ...
            AtomUrlGuesser strategyurl = new AtomUrlGuesser();
            String url = strategyurl.guessArticleUrl(atomArticleLinkList);
            article.setUrl(url);
            String commentUrl = strategyurl.guessCommentUrl(atomArticleLinkList);
