...
public class UserArticle {
    ...
    /**
     * Comma-separated curated feed names.
     */
    @Column(name = "USA_FEEDNAMES_C")
    private String curatedFeedNames;
    /**
     * Getter of id.
     *
     * @return id
    ...
    public String getCuratedFeedNames() {
        return curatedFeedNames;
    }

    public void setCuratedFeedNames(String curatedFeedNames) {
        this.curatedFeedNames = curatedFeedNames;
    }
