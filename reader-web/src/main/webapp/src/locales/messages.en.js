{
  ...
  "report": {
    "loading": "Generating daily report. Please wait...",
    "success": "Daily report sent",
    "error": "Error sending daily report, try again",
    "title": "Daily report",
    "subtitle": "Here is the summary of latest updates for your subscriptions"
  },
  "login": {
    "username": "Username",
    "password": "Password",
  ...
  "category": {
    ...
    "maxnesting": "Maximum nesting level reached",
    "empty": "No category",
    "add": {
      "placeholder": "Name",
      "submit": "Add",
