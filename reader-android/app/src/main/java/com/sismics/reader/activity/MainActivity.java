...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.manage_categories:
                startActivityForResult(new Intent(MainActivity.this, CategoriesActivity.class), Constants.REQUEST_CODE_MANAGE_CATEGORIES.getValue());
                return true;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE_MANAGE_CATEGORIES.getValue() && resultCode == RESULT_OK) {
