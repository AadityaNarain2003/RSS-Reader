...
r.util.url = {
  ...
  bug_report_list: '../api/bug',
  curatedfeed_create : '../api/curated-feed/create',
  similarity_score:'../api/similarity',
  curatedfeed_addArticle : '../api/curated-feed/{id}/addArticle', // Use appropriate token replacements if needed
  curatedfeed_list : '../api/curated-feed/list',
  filter : '../api/filter',
};
